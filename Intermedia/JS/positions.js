...
function addDataToTableAbierta(etiqueta, value) {
    ...
    if (!enc) {
        ...
        cell5.innerHTML = '<button data-bs-opcion="' + (pl > 0 ? 'venta' : 'compra') + '" data-bs-id="' + idd + '" type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal">Cerrar operación</button>';
        ...
        exampleModal.addEventListener('show.bs.modal', function (event) {
            ...
            texto.innerText = 'Va a cerrar esta operación con otra de dirección inversa. El precio puede ser diferente a la fecha en la que se realizó la operación original, pudiendo causar pérdidas. La transacción se realizará en la misma moneda que la operación de origen (' + ob.moneda + ') Revise los datos antes de continuar';
            ...
            modalTitle.textContent = 'Cerrar operación de ' + (opcion == 'compra' ? 'venta' : 'compra');
